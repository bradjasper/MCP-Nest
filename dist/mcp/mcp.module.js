...
exports.McpModule = exports.McpFeatureModule = void 0;
...
const mcp_tool_builder_service_1 = require("./services/mcp-tool-builder.service");
...
let McpFeatureModule = class McpFeatureModule {
};
exports.McpFeatureModule = McpFeatureModule;
exports.McpFeatureModule = McpFeatureModule = __decorate([
    (0, common_1.Module)({})
], McpFeatureModule);
let McpModule = McpModule_1 = class McpModule {
    ...
    static forFeature(providers, serverName) {
        const registration = {
            serverName,
            providerTokens: providers,
        };
        const registrationToken = `${feature_registration_constants_1.MCP_FEATURE_REGISTRATION}_${featureIdCounter++}`;
        return {
    ...
    static forRoot(options) {
        ...
        return {
            ...
            exports: [
                ...
                mcp_tool_builder_service_1.McpToolBuilder,
            ],
        };
    }
    ...
    static createControllersFromOptions(options) {
        ...
        if (transports.includes(interfaces_1.McpTransportType.SSE)) {
            const sseController = (0, sse_controller_factory_1.createSseController)(sseEndpoint, messagesEndpoint, apiPrefix, guards, decorators, options);
            controllers.push(sseController);
        }
        if (transports.includes(interfaces_1.McpTransportType.STREAMABLE_HTTP)) {
            const streamableHttpController = (0, streamable_http_controller_factory_1.createStreamableHttpController)(mcpEndpoint, apiPrefix, guards, decorators, options);
