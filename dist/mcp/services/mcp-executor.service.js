...
let McpExecutorService = McpExecutorService_1 = class McpExecutorService {
    constructor(moduleRef, registry, mcpModuleId, options, authService) {
        this.logger = (0, mcp_logger_factory_1.createMcpLogger)(McpExecutorService_1.name, options);
        this.toolsHandler = new mcp_tools_handler_1.McpToolsHandler(moduleRef, registry, mcpModuleId, options, authService);
