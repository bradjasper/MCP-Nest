...
describe('McpRegistryService', () => {
    ...
    const mockResourceTemplate = (name, uriTemplate) => ({
    ...
    it('should return the correct resource template by URI', () => {
        const result = service.findResourceTemplateByUri(mockMcpModuleId, '/templates/123');
...
describe('McpRegistryService - Single discovery root with multiple MCP servers', () => {
    ...
    ToolsModule = __decorate([
        (0, common_1.Module)({
            imports: [
                mcp_module_1.McpModule.forFeature([Tools], 'server-a'),
                mcp_module_1.McpModule.forFeature([Tools], 'server-b'),
            ],
            providers: [Tools],
            exports: [Tools],
        })
