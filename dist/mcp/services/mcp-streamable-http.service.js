...
const mcp_server_factory_1 = require("../utils/mcp-server.factory");
let McpStreamableHttpService = McpStreamableHttpService_1 = class McpStreamableHttpService {
    constructor(options, mcpModuleId, moduleRef, toolRegistry) {
        ...
        this.logger = (0, mcp_logger_factory_1.createMcpLogger)(McpStreamableHttpService_1.name, this.options);
    }
    async createStatelessServer(rawReq) {
        ...
        const server = (0, mcp_server_factory_1.createMcpServer)(this.mcpModuleId, this.toolRegistry, this.options, this.logger);
    ...
    async handleStatefulRequest(req, res, body) {
        ...
        if (!sessionId && this.isInitializeRequest(body)) {
            ...
            const mcpServer = (0, mcp_server_factory_1.createMcpServer)(this.mcpModuleId, this.toolRegistry, this.options, this.logger);
            const transport = new streamableHttp_js_1.StreamableHTTPServerTransport({
